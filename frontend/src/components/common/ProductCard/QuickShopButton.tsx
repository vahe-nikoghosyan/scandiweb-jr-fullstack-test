...
function QuickShopButton({ product, disabled = false, wrapperClassName }: QuickShopButtonProps) {
  ...
  return (
    <div
      className={`${styles.wrapper} ${wrapperClassName ?? ''}`.trim()}
